      ...
      onSubmit={async (values, actions) => {
        if (currentUser) {
          ...
          await sendAdminEmail({
            subject: `ImpactDB: Tool suggestion from ${currentUser.email}`,
            html: `
              <div>
          ...
          await sendUserEmail({
            ...
            subject: `Thank you for suggesting an tool for ImpactDB`,
            html: `
              <div>
                <p>We have recieved your tool suggestion.</p>
                <p>Subject: ${values.subject}</p>
                <p>Message: ${values.message}</p>
              </div>
            `,
          ...
          onClose();
          toast({
            title: "Success! Thank you for suggesting a new tool",
            status: "success",
            duration: 5000,
            isClosable: true,
          });
          ...
          // give error message
          toast({
            title: "Error: you need to be signed in to suggest a new tool",
            status: "error",
            duration: 5000,
            isClosable: true,
          });
